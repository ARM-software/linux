...
const u16 alcoeff_default_val[AD3_LUT_SIZE] =
...
const u16 asymcoeff_default_val[AD3_LUT_SIZE] =
...
const u16 colorcoeff_default_val[AD3_LUT_SIZE] =
...
static int ad3_firmware_load_global_data(
