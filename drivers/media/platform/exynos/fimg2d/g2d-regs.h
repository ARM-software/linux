...
#define FIMG2D_SUBBLOCK_WIDTH_REG		(0x20C)
...
#define FIMG2D_VERSION_REG			(0x890)
...
#define FIMG2D_SOLID_FILL			(1 << 30)

#define FIMG2D_DST_WR_DEPREMULT  		(1 << 29)
#define FIMG2D_DST_RD_PREMULT			(1 << 27)
#define FIMG2D_PAT_PREMULT			(1 << 26)

#define FIMG2D_SRC_SG_ALPHA_PREMULT		(3 << 24)
#define FIMG2D_SRC_G_ALPHA_PREMULT		(2 << 24)
#define FIMG2D_SRC_S_ALPHA_PREMULT		(1 << 24)
#define FIMG2D_SRC_PREMULT			(1 << 24)
#define FIMG2D_SRC_NO_PREMULT			(0 << 24)
#define FIMG2D_PREMULT_ALL			(0x2d << 24)
...
/* FIMG2D_ROTATE_REG */
#define FIMG2D_FORCE_ROTATE_MODE		(1 << 12)
...
/* FIMG2D_SUBBLOCK_WIDTH_REG */
#define FIMG2D_SUB_BLOCK_WIDTH_MIN		(0x06 << 0)
#define FIMG2D_SUB_BLOCK_WIDTH_MAX		(0x10 << 0)
...
#define FIMG2D_YCBCR_ORDER_P1_CBY1CRY0		(1 << 12)
#define FIMG2D_YCBCR_ORDER_P1_Y1CRY0CB		(2 << 12)
#define FIMG2D_YCBCR_ORDER_P1_Y1CBY0CR		(3 << 12)
